...
class bet_type_activate
{
    ...
    public function confirmation(){
        if ($this->multi_type == 'bulk'){
            return [
                'title' => t('Activate_Bet_Type'),
                'desc' => '',
                'apply_button' => [t('Activate'),'success'],
            ];
        }else{
            return [
                'title' => $this->bet_type['api_key'].' - '.t('Activate'),
                'desc' => '',
                'apply_button' => [t('Activate'),'success'],
            ];
        }
